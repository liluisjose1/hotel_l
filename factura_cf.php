                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active "><a href="#">Consumidor Final</a></li>
                                </ol>
                        ...
                        <div class="row" id="page" >
                            <div class="col-12">
                                ...
                                <div class="card-box table-responsive">
                                        <form action="./reports/factura_cfg.php" method="post">
                                        <div class="form-row">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" value="Servicio de Hotel" id="desc"  required name="desc"  class="form-control">
                                            </div>
                                            <div class="form-group col-md-2">
                                                <label for="inputEmail4" class="col-form-label">Precio Unitario</label>    
